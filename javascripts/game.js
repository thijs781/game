...
function MoveLeft(x,y,newx,newy,take,player){
	//$("#movbut").remove();
	$("#row"+newy+"col"+newx).html('<button id="2" align="center" onclick="CanLeft('+newx+','+newy+','+player+'),CanRight('+newx+','+newy+','+player+')" class="P'+player+'"></button>');
	$("#row"+y+"col"+x).empty();
	if(take == true){
...
function MoveBackLeft(x,y,newx,newy,take,player){
	//$("#movbut").remove();
	$("#row"+newy+"col"+newx).html('<button id="2" align="center" onclick="CanBackLeft('+newx+','+newy+','+player+'),CanBackRight('+newx+','+newy+','+player+')" class="P'+player+'"></button>');
	$("#row"+y+"col"+x).empty();
	if(take == true){
		clearSquare(newx+1,newy+1);
		pieceLost(opponentof(player));
